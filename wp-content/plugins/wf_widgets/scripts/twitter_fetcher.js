        ...
        return {
            ...
            callback: function (e) {
                ...
                var g = [],
                    ...
                    a = [],
                    d = 0;
                if (t) for (c = c.getElementsByClassName("tweet"); d < c.length;) {
                    ...
                    d++
                } else for (c = m(c, "tweet"); d < c.length;) e.push(m(c[d], "e-entry-title")[0]), g.push(m(c[d], "p-author")[0]), f.push(m(c[d], "dt-updated")[0]), 0 < m(c[d], "retweet-credit").length ? a.push(!0) : a.push(!1), d++;
...
// hashtags.
// twitterFetcher.fetch('349128079064567808', 'tweets', 1, true); 