...
if(class_exists('Wf_Widget') && isset(Wf_Widget::$region_html['right']) && class_exists('Comment_form_widget')) {
// Pre-loading the comments widgets
	if(!in_category('blog')) {
		$post_obj = new Post_widget('right steering', 'post', 'show_title=true&ids=2170&widget=post');
		$comment_obj = new Comments_widget('right steering', 'comments', 'comment=Recent comments&date_format=j.n.y  g:i A&post_id=current&widget=comments');
		$comment_form_obj = new Comment_form_widget('right', 'comment_form', 'heading=&widget=comment_form');
	} else {
		$comment_obj = new Comments_widget('bottom', 'comments', 'heading=Comments&date_format=j.n.y  g:i A&post_id=current&widget=comments');
		$comment_form_obj = new Comment_form_widget('bottom', 'comment_form', 'heading=&widget=comment_form');
		
		Wf_Widget::$region_html['bottom'] = $comment_obj->get_html().$comment_form_obj->get_html(); 
	}
}
			...
			<div id="header_lining" class="container">
				...
				<div class='insert_items region_topnav default'>
					<div class='postwrap'>
						...
						<img  src="<?php echo THEME_FOLDER_URL ?>/images/chaco_logo.png" width="200" height="104" alt='Leeds for Change logo'>
					</div>
				</div>
				<div id='l4c_logo'>
				...
				<div id="twocols" class="container"><?php // v2.26
					...
					<div class="row-fluid row">
						...
						<!--<div id='maincol' class="col-sm-8 span8">-->	<?php // v2.26
							...
							// RIGHTCOL ///////////////////////////////////////////////////////////////////////	  ?>
						<!--<div id='rightcol' class="span4">-->
							<!--<div class="wf_lining">-->
							<!--<div id='rightcol' class="col-sm-4">--><?php // v2.26
								//echo get_user_panel();
								//echo $quick_links;
